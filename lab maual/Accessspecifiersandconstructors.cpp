#include <iostream> 
#include <string> // Added this missing header so the 'string' data type works

// Header file for input and output operations 
using namespace std; 
// Allows use of standard library names without std:: 

// Class definition 
class Patient { 
private: 
    // Private access specifier (data security) 
